	...
	for (var state in aus) {
		...
		(function (st, state) {
			...
			st[0].onclick = function () {
				const iframePre = document.querySelector("#previewer");

				switch (state) {
					case "seoul":
						iframePre.src = "./state/seoul.html";
						current = state;
						break;
					case "gygg":
						iframePre.src = "./state/gygg.html";
						current = state;
						break;
					case "incheon":
						iframePre.src = "./state/incheon.html";
						current = state;
						break;
					case "gangwon":
						iframePre.src = "./state/gangwon.html";
						current = state;
						break;
					case "chungbuk":
						iframePre.src = "./state/chungbuk.html";
						current = state;
						break;
					case "chungnam":
						iframePre.src = "./state/chungnam.html";
						current = state;
						break;
					case "daejeon":
						iframePre.src = "./state/daejeon.html";
						current = state;
						break;
					case "sejong":
						iframePre.src = "./state/sejong.html";
						current = state;
						break;
					case "jeonbuk":
						iframePre.src = "./state/jeonbuk.html";
						current = state;
						break;
					case "gwangju":
						iframePre.src = "./state/gwangju.html";
						current = state;
						break;
					case "jeonnam":
						iframePre.src = "./state/jeonnam.html";
						current = state;
						break;
					case "gyeongbuk":
						iframePre.src = "./state/gyeongbuk.html";
						current = state;
						break;
					case "daegu":
						iframePre.src = "./state/daegu.html";
						current = state;
						break;
					case "gyeongnam":
						iframePre.src = "./state/gyeongnam.html";
						current = state;
						break;
					case "ulsan":
						iframePre.src = "./state/ulsan.html";
						current = state;
						break;
					case "busan":
						iframePre.src = "./state/busan.html";
						current = state;
						break;
					case "jeju":
						iframePre.src = "./state/jeju.html";
						current = state;
						break;
